...
public class HelpArticleAPIService {
	...
	public HelpArticleWithImage updateHelpArticle(@RequestBody HelpArticleWithImage helpArticleWithImage, @PathVariable Long id)
	{
		...
		if(helpArticleDb.isPresent())
		{
			...
			helpArticleUpdate.setId(helpArticleWithImage.getId());
			helpArticleUpdate.setTitle(helpArticleWithImage.getTitle());
			helpArticleUpdate.setImageFile(helpArticleWithImage.getImageFile());
			helpArticleUpdate.setImageURL(helpArticleWithImage.getImageURL());
			helpArticleUpdate.setAltText(helpArticleWithImage.getAltText());
			helpArticleUpdate.setSubtitle(helpArticleWithImage.getSubtitle());
			helpArticleUpdate.setParagraph(helpArticleWithImage.getParagraph());
			
			helpArticleImageRepo.save(helpArticleUpdate);
			return helpArticleUpdate;
		}
		else 
		{
			return null;
